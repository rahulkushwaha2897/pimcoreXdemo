...
CREATE TABLE `assets` (
  ...
  `filename` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_bin DEFAULT '',
  `path` varchar(765) CHARACTER SET utf8mb3 COLLATE utf8_bin DEFAULT NULL,
...
INSERT INTO `assets` VALUES (1,0,'folder','','/',NULL,1654598292,1654598292,1,1,NULL,0,0);
...
CREATE TABLE `assets_image_thumbnail_cache` (
  ...
  `filename` varchar(190) CHARACTER SET utf8mb3 COLLATE utf8_bin NOT NULL,
  `modificationDate` int unsigned DEFAULT NULL,
...
CREATE TABLE `documents` (
  ...
  `key` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_bin DEFAULT '',
  `path` varchar(765) CHARACTER SET utf8mb3 COLLATE utf8_bin DEFAULT NULL,
...
INSERT INTO `documents` VALUES (1,0,'page','','/',999999,1,1654598292,1654598292,1,1,0);
...
INSERT INTO `documents_page` VALUES (1,'App\\Controller\\DefaultController::defaultAction','','','',NULL,NULL,NULL,'',NULL,NULL,NULL);
...
CREATE TABLE `http_error_log` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `uri` varchar(1024) CHARACTER SET utf8mb3 COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE `objects` (
  ...
  `o_key` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_bin DEFAULT '',
  `o_path` varchar(765) CHARACTER SET utf8mb3 COLLATE utf8_bin DEFAULT NULL,
...
INSERT INTO `objects` VALUES (1,0,'folder','','/',999999,1,1654598292,1654598292,1,1,NULL,NULL,NULL,NULL,0);
...
CREATE TABLE `properties` (
  ...
  `cpath` varchar(765) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
  `name` varchar(190) NOT NULL DEFAULT '',
...
CREATE TABLE `search_backend_data` (
  `id` int NOT NULL,
  `fullpath` varchar(765) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
...
INSERT INTO `translations_admin` VALUES ('login','simple','en','',1654599271,1654599271);
...
INSERT INTO `users` VALUES (0,0,'user','system',NULL,NULL,NULL,NULL,NULL,NULL,1,1,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,0,'user','admin','$2y$10$29eSt6F4Lsu4JxzWtHl8vexkmN9m2JPgLxPQBrXqoTxqaRhlSH.Z2',NULL,NULL,NULL,'en',NULL,1,1,'','',0,1,1,0,'','','null',NULL,'','','',1654668448,NULL);
...
CREATE TABLE `users_workspaces_asset` (
  `cid` int unsigned NOT NULL DEFAULT '0',
  `cpath` varchar(765) CHARACTER SET utf8mb3 COLLATE utf8_bin DEFAULT NULL,
  `userId` int unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `users_workspaces_object` (
  ...
  UNIQUE KEY `cpath_userId` (`cpath`,`userId`),
  KEY `userId` (`userId`),
  CONSTRAINT `fk_users_workspaces_object_objects` FOREIGN KEY (`cid`) REFERENCES `objects` (`o_id`) ON DELETE CASCADE,
...
-- Dump completed on 2022-06-08 11:54:13
